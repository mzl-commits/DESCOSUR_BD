...
@section('content')
@php
    $cancelUrl = \Illuminate\Support\Facades\Route::has('admin.documentos.index')
        ? route('admin.documentos.index')
        : url()->previous();

    $storeUrl = \Illuminate\Support\Facades\Route::has('admin.documentos.store')
        ? route('admin.documentos.store')
        : '#';
@endphp
